...
List<Data> dataList = [
  ...
  Data(cityName: "Singapore", 
    ...
    attractions: [
      Attraction(
        ...
        attractionDescr: "Marina Bay Sands is an integrated resort fronting Marina Bay in Singapore. The resort is owned by the Las Vegas Sands Corporation and at its opening in 2010, it was deemed the world's most expensive standalone casino property at S$8 billion. The resort includes a 2,561-room hotel, a 120,000-square-metre convention-exhibition centre, the 74,000-square-metre The Shoppes at Marina Bay Sands mall, a museum, a large theatre, "celebrity chef" restaurants, two floating crystal pavilions, art-science exhibits, and the world's largest atrium casino with 500 tables and 1,600 slot machines. The complex includes three towers topped by a connecting 340-metre-long SkyPark with a capacity of 3,902 people and a 150 m infinity swimming pool, set on top of the world's largest public cantilevered platform, which overhangs the north tower by 66.5 m. The 20-hectare resort was designed by Moshe Safdie architects. Marina Bay Sands was originally set to open in 2009, but its construction faced delays caused by escalating costs of material and labour shortages from the outset.",
      ),
      Attraction(
  ...
  Data(cityName: "Rio de Janeiro", 
    ...
    attractions: [
      ...
      Attraction(
        attractionName: "Royal Portuguese Reading Room",
